...
class GetTasks(Command):
    ...
    def register_arguments(self):
        ...
        self.parser.add_argument('--sort', action=TaskSortParser, nargs='+', metavar=('COLUMN', '[DIRECTION]'), default=Sort(TaskSortColumn.DUE_DATE), help='Order by which to sort the tasks. Supply a snake_case column (either set_date or due_date; defaults to due_date) and optionally a direction (either asc or desc; defaults to desc).')
